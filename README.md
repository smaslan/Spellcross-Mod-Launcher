...
The tool has [help](https://htmlpreview.github.io?https://github.com/smaslan/Spellcross-Mod-Launcher/blob/master/help/help_eng.html) in the application folder. It should be able to launch the HTML help via menu (it may fail due to Windows security policies). If not, open it manually using your browser.
