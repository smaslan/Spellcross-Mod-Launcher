...
{
	// <wxFormsBuilder> - Section auto-inserted from 'forms.cpp' class 'FormMain' on 2026-08-16 11:32:54
	...
	cbModRandomize = new wxCheckBox( this, wxID_CB_MOD_RANDOMIZE, _("Allow randomize units"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer122->Add( cbModRandomize, 0, wxRIGHT|wxLEFT, 5 );
	...
	cbModRandomize->SetValue(m_ini->GetBoolValue("SETUP","allow_units_randomize",true));
...
void FormMain::OnClose(wxCloseEvent& ev)
{
	...
	m_ini->SetBoolValue("SETUP","allow_units_randomize",cbModRandomize->GetValue(),"; Allow units randomization");
...
{		
	...
	SpellMod::Config mod_config;
	mod_config.randomize = m_config.allow_unit_mod;
...
void FormMain::OnBuildMod(wxCommandEvent& event)
{
	...
	config.allow_unit_mod = cbModRandomize->GetValue();
