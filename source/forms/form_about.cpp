...
FormAbout::FormAbout( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText80 = new wxStaticText(this,wxID_ANY,_("Spellcross Mod Launcher"),wxDefaultPosition,wxDefaultSize,0);
	...
	m_textCtrl17 = new wxTextCtrl(this,wxID_ANY,_("Version:"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	m_textCtrl171 = new wxTextCtrl(this,wxID_ANY,_("Author:"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	m_textCtrl172 = new wxTextCtrl(this,wxID_ANY,_("Email:"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	m_textCtrl173 = new wxTextCtrl(this,wxID_ANY,_("URL:"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	m_textCtrl174 = new wxTextCtrl(this,wxID_ANY,_("License:"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	txtVersion = new wxTextCtrl(this,wxID_TXT_VER,_("V1.00, 2025-11-16"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	txtName = new wxTextCtrl(this,wxID_TXT_NAME,_("Stanislav Mašláò"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	txtEmail = new wxTextCtrl(this,wxID_TXT_EMAIL,_("s.maslan@seznam.cz"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	txtURL = new wxTextCtrl(this,wxID_TXT_URL,_("https://github.com/smaslan/Spellcross-Mod-Launcher"),wxDefaultPosition,wxDefaultSize,wxTE_AUTO_URL|wxTE_RICH|wxBORDER_NONE);
	...
	txtLicense = new wxTextCtrl(this,wxID_TXT_LICENSE,_("MIT License, (c) 2026, Stanislav Mašláò"),wxDefaultPosition,wxDefaultSize,wxTE_RICH|wxBORDER_NONE);
	...
	imgLogo = new wxStaticBitmap(this,wxID_IMG,wxNullBitmap,wxDefaultPosition,wxDefaultSize,0);
	bSizer74->Add(imgLogo,0,wxALL|wxEXPAND,5);
	...
	btnOK = new wxButton(this,wxID_BTN_OK,_("OK"),wxDefaultPosition,wxDefaultSize,0);
	...
	wxIcon ico;
	ico.LoadFile("IDI_ABOUT",wxBITMAP_TYPE_ICO_RESOURCE,64,78);
	if(ico.IsOk())
		imgLogo->SetBitmap(ico);
